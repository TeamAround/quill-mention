...
var MentionBlot = /*#__PURE__*/function (_Embed) {
  ...
  _createClass(MentionBlot, null, [{
    ...
    value: function create(data) {
      ...
      var denotationChar = node.ownerDocument.createElement("span");
...
var Mention = /*#__PURE__*/function () {
  function Mention(quill, options) {
    ...
    var doc = this.quill.container.ownerDocument; //create mention container

    this.mentionContainer = doc.createElement("div");
    ...
    this.mentionList = doc.createElement("ul");
  ...
  _createClass(Mention, [{
    ...
    value: function renderList(mentionChar, data, searchTerm) {
      if (data && data.length > 0) {
        ...
        for (var i = 0; i < data.length; i += 1) {
          var li = this.quill.container.ownerDocument.createElement("li");
    ...
    value: function containerRightIsNotVisible(leftPos, containerPos) {
      ...
      var browserWidth = this.window.pageXOffset + this.quill.container.ownerDocument.documentElement.clientWidth;
